...
1. provideHttpCLient
2. skeleton in loading
3. error in tpl
4. look at the signals in list
5. implement productResource
6. use productResource in list
  a. loading,
  b. error
  c. product @for
...
//
// the last step is to make sure that the last tap operator sets
