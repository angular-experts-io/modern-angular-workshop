// TODO 28: Let's improve UX even more by adding a guard to confirm if the user
...
// let's create a "confirmDiscardUnsavedChanges" function which will accept a form
// (with FieldTree<unknown> type)
// inside the function were going to check it the provided form instance is "dirty()"
